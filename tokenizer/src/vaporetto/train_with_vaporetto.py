...
from core import VaporettoPreTokenizer
...
def wordpiece(args):
    """Train a WordPiece-based tokenizer.
    """
    # init
...
def unigram(args):
    """Train a UnigramLM-based tokenizer.
    """
    # init
...
if __name__ == '__main__':
    ...
    parser = ArgumentParser(
        description="Training a tokenizer with Vaporetto."
    )
    parser.add_argument(
        "--data_path", 
