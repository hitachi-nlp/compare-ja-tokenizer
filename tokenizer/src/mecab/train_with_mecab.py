...
def wordpiece(args):
    """Train a WordPiece-based tokenizer with Mecab."""
    # init
...
def unigram(args):
    """Train a Unigram-based tokenizer with Mecab."""
    # init
...
def bpe(args):
    """Train a BPE-based tokenizer with Mecab."""
    # init
...
if __name__ == '__main__':
    ...
    parser = ArgumentParser(
        description="Training a tokenizer with MeCab."
    )
    parser.add_argument(
        "--data_path", 
