...
PRETOKENIZER=jumanpp
export TOKENIZERS_PARALLELISM=true

python -u -m supar.cmds.biaffine_dep train -b -d 0 -c ./config/juman++/${PRETOKENIZER}_${SUBWORD_TOKENIZER}.ini -p ${PRETOKENIZER}_${SUBWORD_TOKENIZER}_${SEED} \
	--seed=${SEED} \
