...
def main(args):
    ...
    # load tokenizer data
    sentences = open('../data/sentence/tokenizer_data_wiki.txt', 'r').readlines()
    ...
    with open(f"../data/pretraining/pretrain_sentence_wiki.txt", "w") as fp:
...
if __name__ == '__main__':
    ...
    parser = ArgumentParser(
        description="Generating a pretraining data with MeCab."
    )
    parser.add_argument(
        "--tokenizer_path", 
